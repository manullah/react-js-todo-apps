...
const BoardCreateDialog = props => {
  const { open, onOpenChange, onSuccess } = props;

  const { form, isLoading, onSubmit, onReset } = useBoardCreateForm({
    onSuccess: data => {
      onSuccess(data);
      onOpenChange(false);
    },
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Organize tasks visually with a customizable Kanban board.
          </DialogDescription>
        </DialogHeader>
